...
vaccination_data = pd.read_csv(current_directory +'\\vaccinations.csv')
df = pd.DataFrame(vaccination_data)

imf_data = pd.read_csv(current_directory + '\\imf-who-covid-19-vaccine-supply-tracker.csv',skiprows=2, engine='python')
